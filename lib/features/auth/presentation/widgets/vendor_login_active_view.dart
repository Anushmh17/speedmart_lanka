...
class VendorLoginActiveView extends StatelessWidget {
  const VendorLoginActiveView({
    super.key,
      ...
      body: SafeArea(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            const vendorCardHeight = 420.0;
            final screenHeight = constraints.maxHeight;
            final topGap = (screenHeight * 0.055).clamp(32.0, 58.0);
            final blockHeight = heroHeight + vendorCardHeight - cardOverlap;
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            left: 24,
                            right: 24,
                            child: _buildCard(vendorCardHeight, isDark),
                          ),
                        ],
                      ),
                    ),
