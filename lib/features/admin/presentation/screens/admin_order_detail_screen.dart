...
class AdminOrderDetailScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            _infoCard(cardColor, borderColor, [
              ...
              _divider(),
              _row('Status', order.status.displayName, primaryText, secondaryText),
              _divider(),
              _row('Date', '${order.createdAt.day}/${order.createdAt.month}/${order.createdAt.year}', primaryText, secondaryText),
              _divider(),
              _row('Payment Method', order.paymentMethod.displayName, primaryText, secondaryText),
              _divider(),
              _row('Payment Status', order.paymentStatus.name.toUpperCase(), primaryText, secondaryText),
            ]),
            const SizedBox(height: 16),
            Text('Shop Owner', style: AppTextStyles.h2(primaryText)),
            const SizedBox(height: 8),
            _infoCard(cardColor, borderColor, [
              _row('Business', order.vendorBusinessName, primaryText, secondaryText),
              _divider(),
            ...
            _infoCard(cardColor, borderColor, [
              ...
              _divider(),
              _row('Phone', order.customerPhone, primaryText, secondaryText),
              _divider(),
              _row('Address', order.deliveryAddress, primaryText, secondaryText),
            ]),
            const SizedBox(height: 16),
                ...
                children: [
                  ...order.items.map((item) => Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Expanded(child: Text(item.requestItemName, style: AppTextStyles.bodyMedium(primaryText))),
                            Text('x${item.quantity}', style: AppTextStyles.bodySmall(secondaryText)),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('Rs. ${order.deliveryCharge.toStringAsFixed(2)}', style: AppTextStyles.bodyMedium(primaryText)),
                    ],
                  ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('Order Total', style: AppTextStyles.subtitle(primaryText)),
  ...
  Widget _infoCard(Color cardColor, Color borderColor, List<Widget> children) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: cardColor,
  ...
  Widget _row(String label, String value, Color primary, Color secondary) {
    return Row(
      ...
      children: [
        ...
        Flexible(child: Text(value, style: AppTextStyles.bodyMedium(primary), textAlign: TextAlign.end)),
      ],
    );
  }
