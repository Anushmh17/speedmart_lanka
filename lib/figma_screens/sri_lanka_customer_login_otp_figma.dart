...
class SrilankacustomerloginotpWidget extends StatefulWidget {
  ...
  State<SrilankacustomerloginotpWidget> createState() =>
      SrilankacustomerloginotpWidgetState();
}

class SrilankacustomerloginotpWidgetState
    extends State<SrilankacustomerloginotpWidget> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    // OTP boxes top position
    final otpBoxTop = y(530);
    final otpBoxBottom = otpBoxTop + y(48);
    final coveredBy = (otpBoxBottom + 10.0 - (h - keyboardHeight))
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: Colors.white, width: x(2.5)),
                              ),
                              child: Icon(Icons.arrow_back_rounded,
                                  color: Colors.white, size: x(20)),
                            ),
                          ),
                        ),
                        Positioned(
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(x(10)),
                              border: Border.all(
                                  color: const Color(0xFFFF8213), width: x(2)),
                            ),
                            child: Row(
                              children: [
                                SizedBox(width: x(11)),
                            ...
                            child: Row(
                              ...
                              children: List.generate(6, (index) {
                                return _OtpBox(
                                  ...
                                  onTap: () {
                                    final target = _otpControllers
                                        .indexWhere((c) => c.text.isEmpty);
                                    final node = _otpFocusNodes[
                                        target == -1 ? 5 : target];
                                    node.requestFocus();
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(Icons.verified_user_outlined,
                                  color: const Color(0xFF373737), size: x(16)),
                              SizedBox(width: x(6)),
