...
class InternationalcustomerregistrationotpWidget extends StatefulWidget {
  final VoidCallback? onBack;
  final ValueChanged<String>? onVerifyOtp;
  final VoidCallback? onResend;
  final String maskedEmail;

  const InternationalcustomerregistrationotpWidget({
    super.key,
    this.onBack,
    this.onVerifyOtp,
    this.onResend,
  ...
  @override
  State<InternationalcustomerregistrationotpWidget> createState() =>
      _InternationalcustomerregistrationotpWidgetState();
}

class _InternationalcustomerregistrationotpWidgetState
    extends State<InternationalcustomerregistrationotpWidget> {
  static const String _assetBase =
      'assets/images/figma/international_customer_register_otp/';
                    ...
                    Positioned(
                      ...
                      child: Center(
                        child: Container(
                          ...
                          decoration: BoxDecoration(color: const Color(0xFF161616), borderRadius: BorderRadius.circular(x(10))),
                        ),
                      ),
                    ),
                    Positioned(
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: Colors.white, width: x(2.5))),
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Icon(Icons.email_outlined, color: const Color(0xFFFF8213), size: x(23)),
                            ),
                            SizedBox(width: x(12)),
                            Expanded(
                              child: Column(
