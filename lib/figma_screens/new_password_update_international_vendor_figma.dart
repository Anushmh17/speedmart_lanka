...
class NewpasswordupdateforinternationalvendorWidget extends StatefulWidget {
  ...
  const NewpasswordupdateforinternationalvendorWidget({
    super.key,
    this.onBack,
  ...
  @override
  State<NewpasswordupdateforinternationalvendorWidget> createState() =>
      _NewpasswordupdateforinternationalvendorWidgetState();
}

class _NewpasswordupdateforinternationalvendorWidgetState
    extends State<NewpasswordupdateforinternationalvendorWidget> {
  static const String _assetBase =
      'assets/images/figma/new_password_update_international_vendor/';
  ...
  void _handleUpdatePassword() {
    ...
    debugPrint(
      'International vendor update password clicked: ${_passwordController.text}',
    );
  }
