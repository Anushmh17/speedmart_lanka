...
class InternationalvendorregistrationotpWidget extends StatefulWidget {
  final VoidCallback? onBack;
  final ValueChanged<String>? onVerifyOtp;
  final VoidCallback? onResend;
  final String maskedEmail;

  const InternationalvendorregistrationotpWidget({
    super.key,
    this.onBack,
    this.onVerifyOtp,
    this.onResend,
  ...
  @override
  State<InternationalvendorregistrationotpWidget> createState() =>
      _InternationalvendorregistrationotpWidgetState();
}

class _InternationalvendorregistrationotpWidgetState
    extends State<InternationalvendorregistrationotpWidget> {
  static const String _assetBase =
      'assets/images/figma/international_vendor_register_otp/';
  ...
  Future<void> _handleVerifyOtp() async {
    ...
    debugPrint('International vendor register OTP verified, navigate to vendor pending approval');
  }

  void _handleResend() {
    if (widget.onResend != null) { widget.onResend!(); return; }
    debugPrint('International vendor register Resend OTP clicked');
  }
      ...
      child: Theme(
        data: Theme.of(context).copyWith(
          ...
          inputDecorationTheme: const InputDecorationTheme(
            ...
            focusedBorder: InputBorder.none, filled: false, fillColor: Colors.transparent,
          ),
        ),
        child: Scaffold(
          ...
          body: GestureDetector(
            ...
            child: SizedBox(
              ...
              child: AnimatedSlide(
                ...
                child: Stack(
                  children: [
                    Positioned(top: 0, left: 0, right: 0, height: y(360),
                      child: Image.asset('${_assetBase}Vendorloginuinewhero1.png', fit: BoxFit.fill)),
                    Positioned(top: y(37.5), left: 0, right: 0,
                      child: Center(child: Container(
                        width: x(213), height: y(45),
                        decoration: BoxDecoration(color: Colors.black, borderRadius: BorderRadius.circular(x(10))),
                      ))),
                    Positioned(top: y(58), left: 0, right: 0,
                      child: Center(child: Image.asset('${_assetBase}Speedmart_lk_transparent_logo_cropped1.png',
                          width: x(185), height: y(26), fit: BoxFit.contain))),
                    Positioned(top: y(45), left: x(15),
                    ...
                    Positioned(top: y(363), left: x(18), right: x(18),
                      child: Column(children: [
                        Text('Verify OTP', textAlign: TextAlign.center,
                          style: GoogleFonts.montserrat(color: const Color(0xFFFFEBFF),
                              fontSize: fs(33), fontWeight: FontWeight.w800, letterSpacing: -0.4, height: 1)),
                        SizedBox(height: y(20)),
                        Text('Enter the code sent to your email', textAlign: TextAlign.center,
                          style: GoogleFonts.montserrat(color: const Color(0xFFEEB556),
                              fontSize: fs(18), fontWeight: FontWeight.w700, height: 1)),
                      ])),
                    Positioned(top: y(460), left: x(43), right: x(42),
                      child: Container(
                        height: y(60),
                    ...
                    Positioned(top: y(547), left: x(20), right: x(19),
                      child: SizedBox(
                        height: y(48),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: List.generate(6, (index) => _VendorOtpBox(
                    ...
                    if (_errorMessage.isNotEmpty)
                      Positioned(top: y(600), left: x(22), right: x(22),
                      ...
                      Positioned(top: y(600), left: x(22), right: x(22),
                        child: Text(_successMessage, textAlign: TextAlign.center,
                          style: TextStyle(color: const Color(0xFF4CAF50), fontFamily: 'OpenSans',
                              fontSize: fs(13), fontWeight: FontWeight.w600, height: 1))),
                    Positioned(top: y(624), left: x(22), right: x(22),
                      child: SizedBox(
                        height: y(49),
                        child: ElevatedButton(
                          onPressed: _successMessage.isNotEmpty ? null : _handleVerifyOtp,
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFFFF8213), foregroundColor: Colors.white,
                          ...
                          child: Text('Verify OTP', style: TextStyle(color: Colors.white,
                              fontFamily: 'OpenSans', fontSize: fs(18), fontWeight: FontWeight.w700, height: 1)),
                        ),
                      )),
                    Positioned(top: y(703), left: 0, right: 0,
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        SizedBox(width: x(5)),
                        GestureDetector(onTap: _handleResend,
                    ...
                    Positioned(top: y(738), left: 0, right: 0,
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
