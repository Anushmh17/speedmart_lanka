...
class InternationalvendorregistrationWidget extends StatefulWidget {
  ...
  const InternationalvendorregistrationWidget({
    super.key,
    this.onBack,
  ...
  @override
  State<InternationalvendorregistrationWidget> createState() =>
      _InternationalvendorregistrationWidgetState();
}

class _InternationalvendorregistrationWidgetState
    extends State<InternationalvendorregistrationWidget> {
  static const String _assetBase =
      'assets/images/figma/international_vendor_register/';
  ...
  @override
  void didUpdateWidget(covariant InternationalvendorregistrationWidget oldWidget) {
  ...
  void _handleCreateAccount() {
    ...
    debugPrint('International vendor Create Account clicked');
  }
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.only(
                ...
                topRight: Radius.circular(
                  width > 150 && !isInternational ? x(11) : 0,
                ),
              ...
              border: Border.all(
                color:
                    isInternational ? const Color(0xFFFF0000) : Colors.white,
                width: isInternational ? x(1.5) : x(1),
              ),
            ),
            child: Row(
              children: [
                SizedBox(width: x(isInternational ? 20 : 13)),
                Expanded(
                  child: Text(
                    title,
              ...
              SizedBox(
                ...
                child: FlutterMap(
                  ...
                  options: MapOptions(
                    ...
                    initialZoom: hasLocation ? 14.0 : 3.0,
                    minZoom: 2,
                    maxZoom: 19,
                  ),
                  children: [
                  ...
                  children: [
                    if (hasLocation)
                      FloatingActionButton.small(
                        heroTag: 'intlv-reg-map-recenter',
                    ...
                    FloatingActionButton.small(
                      heroTag: 'intlv-reg-map-detect',
                      onPressed: widget.isDetectingLocation
                          ? null
                          : (widget.onUseCurrentLocation ??
                              () => debugPrint(
                                    'International vendor Use Current Location clicked',
                                  )),
                      backgroundColor: Colors.white,
                      foregroundColor: const Color(0xFFFB6F02),
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: widget.onSignIn ??
                                () => debugPrint(
                                      'International vendor Sign In clicked',
                                    ),
                            child: Text(
                              'Sign In',
                              style: TextStyle(
