...
class InternationalvendorloginWidget extends StatefulWidget {
  ...
  const InternationalvendorloginWidget({
    super.key,
    this.onSignIn,
    this.onRegister,
  ...
  @override
  State<InternationalvendorloginWidget> createState() =>
      _InternationalvendorloginWidgetState();
}

class _InternationalvendorloginWidgetState
    extends State<InternationalvendorloginWidget> {
  ...
  static const String _assetBase =
      'assets/images/figma/international_vendor_login/';
  ...
  void _handleSignIn() {
    ...
    debugPrint('International vendor Sign In clicked: ${_emailController.text}');
  }
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: widget.onForgotPassword ??
                            () => debugPrint(
                                  'International vendor forgot password clicked',
                                ),
                        child: Text(
                          'Forgot Password?',
                          style: TextStyle(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: widget.onRegister ??
                                () => debugPrint(
                                      'International vendor Register Now clicked',
                                    ),
                            child: Text(
                              'Register Now',
                              style: TextStyle(
