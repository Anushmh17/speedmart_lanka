...
class InternationalcustomerloginotpWidget extends StatefulWidget {
  final VoidCallback? onBack;
  final ValueChanged<String>? onVerifyOtp;
  final VoidCallback? onResend;
  final String maskedEmail;

  const InternationalcustomerloginotpWidget({
    super.key,
    this.onBack,
    this.onVerifyOtp,
    this.onResend,
  ...
  @override
  State<InternationalcustomerloginotpWidget> createState() =>
      _InternationalcustomerloginotpWidgetState();
}

class _InternationalcustomerloginotpWidgetState
    extends State<InternationalcustomerloginotpWidget> {
  static const String _assetBase =
      'assets/images/figma/international_customer_login_otp/';
