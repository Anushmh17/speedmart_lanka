...
class InternationalvendorloginotpWidget extends StatefulWidget {
  final VoidCallback? onBack;
  final ValueChanged<String>? onVerifyOtp;
  final VoidCallback? onResend;
  final String maskedEmail;

  const InternationalvendorloginotpWidget({
    super.key,
    this.onBack,
    this.onVerifyOtp,
    this.onResend,
  ...
  @override
  State<InternationalvendorloginotpWidget> createState() =>
      _InternationalvendorloginotpWidgetState();
}

class _InternationalvendorloginotpWidgetState
    extends State<InternationalvendorloginotpWidget> {
  static const String _assetBase =
      'assets/images/figma/international_vendor_login_otp/';
  ...
  Future<void> _handleVerifyOtp() async {
    ...
    debugPrint('International vendor OTP verified, navigate to vendor dashboard');
  }
  ...
  void _handleResend() {
    ...
    debugPrint('International vendor Resend OTP clicked');
  }
