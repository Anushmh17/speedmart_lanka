...
class InternationalvendorforgetpasswordWidget extends StatefulWidget {
  ...
  const InternationalvendorforgetpasswordWidget({
    super.key,
    this.onBack,
  ...
  @override
  State<InternationalvendorforgetpasswordWidget> createState() =>
      _InternationalvendorforgetpasswordWidgetState();
}

class _InternationalvendorforgetpasswordWidgetState
    extends State<InternationalvendorforgetpasswordWidget> {
  static const String _assetBase =
      'assets/images/figma/international_vendor_forget_password/';
  ...
  void _handleSendResetCode() {
    ...
    debugPrint(
      'International vendor reset code clicked: ${_emailController.text}',
    );
  }
