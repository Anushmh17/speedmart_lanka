...
class InternationalvendorforgetpasswordotpWidget extends StatefulWidget {
  final VoidCallback? onBack;
  final VoidCallback? onSignIn;
  final VoidCallback? onResendCode;
  final ValueChanged<String>? onVerifyCode;

  const InternationalvendorforgetpasswordotpWidget({
    super.key,
    this.onBack,
    this.onSignIn,
    this.onResendCode,
  ...
  @override
  State<InternationalvendorforgetpasswordotpWidget> createState() =>
      _InternationalvendorforgetpasswordotpWidgetState();
}

class _InternationalvendorforgetpasswordotpWidgetState
    extends State<InternationalvendorforgetpasswordotpWidget> {
  static const String _assetBase =
      'assets/images/figma/international_vendor_forget_password_otp/';
  ...
  void _handleVerifyCode() {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => const NewpasswordupdateforinternationalvendorWidget(),
      ),
    );
  }
  ...
  void _handleResendCode() {
    ...
    debugPrint('International vendor forget password resend code clicked');
  }
