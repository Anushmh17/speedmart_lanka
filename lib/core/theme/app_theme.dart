...
/// Material 3 theme system for Speedmart Lanka.
/// Provides lightTheme and darkTheme — both fully configured.
class AppTheme {
  AppTheme._();
    ...
    return ThemeData(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          textStyle: AppTextStyles.button(AppColors.primaryLight),
        ),
      ),
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
          foregroundColor: AppColors.primaryLight,
          textStyle: AppTextStyles.labelLarge(AppColors.primaryLight),
        ),
      ),
